...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/patteruel-dev/LoginService'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'patteruel-dev' => 'jpteruel95@gmail.com' }
  s.source           = { :git => 'https://github.com/patteruel-dev/LoginService.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'LoginService' => ['LoginService/Assets/*.png']
  # }

  # s.public_header_files = 'Pod/Classes/**/*.h'
  # s.frameworks = 'UIKit', 'MapKit'
  s.dependency 'MALSwift'
end
